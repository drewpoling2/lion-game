...
var JUMP_SPEED = 0.35;
var DOUBLE_JUMP_SPEED = 0.4; // Adjust this as needed
var GRAVITY = 0.0015;
...
function createCactus(newPosition) {
  ...
  (0, _updateCustomProperty.setCustomProperty)(cactus, 'height', "".concat(randomNumberBetween(22, 27), "%"));
...
},{"../../server/common/errors":"../../../server/common/errors.ts"}],"../elements/leaderboard.js":[function(require,module,exports) {
"use strict";
